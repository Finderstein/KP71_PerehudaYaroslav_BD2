...
class Controller {
    ...
    Controller(Model model, View view) {
        this.model = model;
        this.view = view;
        this.tableName.add("Authors");
        this.tableName.add("Books");
        this.tableName.add("Readers");
        this.tableName.add("Reading");
    }
    ...
    private void showTableMenu(int tableNumber) {
        ...
        {
            case 1:
                rs = model.select_all_from_table_authors();
                view.show_from_table_authors(rs , true);
                break;
            case 2:
                rs = model.select_all_from_table_books();
                view.show_from_table_books(rs , true);
                break;
            case 3:
                rs = model.select_all_from_table_readers();
                view.show_from_table_readers(rs, true);
                break;
            case 4:
                rs = model.select_all_from_table_reading();
                view.show_from_table_reading(rs, true);
                break;
        }
    ...
    private void updateInTableAuthors() {
        ...
        do
        {
            ...
            authorId = getInt();
            ResultSet rs = model.select_by_id_from_table_authors(authorId);
            ...
            try {
                ...
                else
                {
                    ...
                    view.show_from_table_authors(rs, false);
            ...
            } catch (SQLException | NumberFormatException sqlExcept){
    ...
    private void updateInTableBooks() {
        ...
        do
        {
            ...
            bookId = getInt();
            ResultSet rs = model.select_by_id_from_table_books(bookId);
            ...
            try {
                ...
                {
                    System.out.println("In db exists this data: ");
                    view.show_from_table_books(rs, false);
                    view.showUpdateMenu2();
                    choose = Integer.parseInt(scanner.nextLine());
                    if (choose == 1)
                        break;
    ...
    private void updateInTableReaders() {
        ...
        do
        {
            ...
            readerId = getInt();
            ResultSet rs = model.select_by_id_from_table_readers(readerId);
            ...
            try {
                if (!rs.isBeforeFirst()) {
                    ...
                    System.out.println("In db exists this data: ");
                    view.show_from_table_readers(rs, false);
                    view.showUpdateMenu2();
                    choose = Integer.parseInt(scanner.nextLine());
                    if (choose == 1)
                        break;
    ...
    private void updateInTableReading() {
        ...
        do
        {
            ...
            readingId = getInt();
            ResultSet rs = model.select_by_id_from_table_reading(readingId);
            ...
            try {
                if (!rs.isBeforeFirst()) {
                    ...
                    System.out.println("In db exists this data: ");
                    view.show_from_table_reading(rs, false);
                    view.showUpdateMenu2();
                    choose = Integer.parseInt(scanner.nextLine());
                    if (choose == 1)
                        break;
    ...
    private void  DynamicSearch() {
        ...
        ResultSet rs = model.search_from_2_tables(name, from, to);

        view.showSearchFrom2Tables(rs);
    }
    ...
    private void noWordSearchMenu() {
        ...
        ResultSet rs = model.noWordSearch(wordToSearch);
